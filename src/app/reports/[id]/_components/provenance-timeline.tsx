...
const COUNT_LABEL: Record<string, string> = {
  ...
  fresh_candidate_count: "近期候选", fresh_selected_count: "近期选中", cohort_candidate_content_count: "观察批候选", cohort_candidate_source_count: "观察批候选来源",
  cohort_selected_count: "观察批选中", cohort_selected_source_count: "观察批选中来源", input_content_count: "分析输入", analysis_insight_count: "产出洞察", no_significant_event: "无重要事件",
