...
const mocks = vi.hoisted(() => ({ actor: vi.fn(), audit: vi.fn(), page: vi.fn(), db: {} }));
...
describe("GET /api/admin/metrics/details", () => {
  ...
  beforeEach(() => { mocks.actor.mockReset().mockResolvedValue({ id: "admin_1" }); mocks.audit.mockReset(); mocks.page.mockReset().mockReturnValue({ items: [{ event_id: "event_2" }], next: { occurred_at: "2026-08-01T01:00:00.000Z", id: "event_2" } }); });
