...
const TIMELINE_METRIC_KEYS = new Set([
  ...
  "fresh_candidate_count", "fresh_selected_count", "input_content_count", "analysis_insight_count", "no_significant_event", "citation_total", "citation_pass", "citation_blocked",
