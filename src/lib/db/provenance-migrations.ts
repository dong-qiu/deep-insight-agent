...
DELETE FROM dashboard_cost_fact_v1 WHERE tenant_id='default' AND EXISTS (
  ...
  { version: "20260916_45_report_quality_review_trace_v1", sql: REPORT_REVIEW_TRACE_V1_SCHEMA_SQL },
];
