...
function writeLock(root: string, overrides: Record<string, unknown> = {}): string {
  ...
  const lock = {
    ...
    snapshot: { immutable_reference: "s3://controlled/a1-v2/manifest", collected_at: "2026-09-10T00:00:00Z", source_manifest_reference: "s3://controlled/a1-v2/sources.json", source_manifest_sha256: "a".repeat(64), license_and_retention: "internal retention=90d" },
    files: {
